<template>
      <v-toolbar flat class="px-0">
        <v-toolbar-title>Test Items</v-toolbar-title>
  ...
  export default {
    ...
    methods: {
        ...
        Save(e) {
          ...
          if (this.id) {
            axios
              .post("/Basket_Items/crud-template-update/" +this.id, data, config)
              .then((response) => {
                this.TestItems();
                this.close();
              })
            ...
            axios
              .post("/Basket_Items/crud-template-store", data, config)
              .then((response) => {
                this.TestItems();
                this.close();
              })
        ...
        async deleteBasketItem() {
            var res = await axios.delete("/Basket_Items/crud-template-delete/" + this.id);
            if (res.status === 200) {
              this.TestItems();
        ...
        search() {
            axios.get('/Basket_Items/search/crud-template/?s=' + this.table_search).then((response) => {
